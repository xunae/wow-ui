local L = BigWigs:NewBossLocale("High Priestess Jeklik", "esES") or BigWigs:NewBossLocale("High Priestess Jeklik", "esMX")
...
local L = BigWigs:NewBossLocale("Jin'do the Hexxer", "esES") or BigWigs:NewBossLocale("Jin'do the Hexxer", "esMX")
if L then

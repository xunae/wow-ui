...
do
	...
	function AGSMW:GetBaseFrameWithWindow()
		...
		local displayButton = CreateFrame("Button", nil, frame, "BackdropTemplate")  -- MSA
...
do
	...
	function AGSMW:GetDropDownFrame()
		...
		if next(DropDownCache) then
			...
			frame = CreateFrame("Frame", nil, UIParent, "BackdropTemplate")  -- MSA
			...
			local slider = CreateFrame("Slider", nil, scrollframe, "BackdropTemplate")  -- MSA

...
L["Animate"] = "애니메이션"
L["Apply 'Icons' alpha settings to the status bar"] = "'아이콘' 투명도 설정을 진행바에 적용"
L["Ascending"] = "오름차순"
L["Assign Raid Cooldowns."] = "공대 쿨기 지정"
...
L["Clean wipe the savedvariable file. |cffff2020Warning|r: This can not be undone!"] = "savedvariable 파일 초기화. |cffff2020Warning|r: 되돌리기 불가!"
L["Columns"] = "열"
L["Commands:"] = "명령어:"
L["Cooldown"] = "재사용 대기시간"
L["Copy"] = "복사"
...
L["Jump to Extra Bars settings"] = "추가바 설정으로 이동"
L["Layout"] = "배열"
L["LEFT"] = "좌측"
L["License"] = "라이센스"
...
L["Move your group's Interrupt spells to the Interrupt Bar."] = "그룹 차단기를 차단바로 이동"
L["Move your group's Raid Cooldowns to the Raid Bar."] = "그룹 공대쿨기를 공대바로 이동"
L["Notes"] = "주석"
...
L["Replace default timers with a status bar timer."] = "기본 타이머를 진행바 타이머로 교체"
...
L["Reset Status Bar Timer settings to default"] = "진행바 타이머 설정 초기화"
...
L["Set the status bar width. Adjust height with 'Icon Size'."] = "진행바 너비 설정. 높이는 '아이콘 크기'로 조절 하십시오"
...
L["Show Player"] = "자기 주문바 보이기"
L["Show Player in Extra Bars"] = "추가바에 자기 주문 보이기"
L["Show player spells in the Extra Bars regardless of 'Show Player' setting."] = "'자기 주문바 보이기' 설정을 무시하고 추가바에 자기 자신의 주문을 표시합니다. "
...
L["Toggle raid-style party frame and player spell bar for testing"] = "테스트를 위한 플레이어의 공격대창 형태의 파티창과 주문바를 켜거나 끕니다"

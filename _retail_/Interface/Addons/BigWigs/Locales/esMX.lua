...
L.guildRelease = "Estás usando la versión %d de BigWigs hecha para tu gremio, basado en la versión %d del addon oficial."
...
L.warnOldBase = "Estás usando la versión de gremio de BigWigs (%d), pero tu versión base (%d) está %d versiones desactualizada. Esto puede provocar problemas."
...
L.slashDescPull  = "|cFFFED000/pull:|r Envia una cuenta regresiva de llamado al jefe a tu banda."
L.slashDescBreak  = "|cFFFED000/break:|r Crea un temporizador de descanso para tu banda."
L.slashDescRaidBar  = "|cFFFED000/raidbar:|r Envia una barra personalizada a tu banda."
L.slashDescLocalBar  = "|cFFFED000/localbar:|r Crea una barra personal que solo puedes ver tú."
...
L.ICON_desc  = "BigWigs puede marcar personajes afectados por habilidades con un ícono. Esto hace que sea más fácil detectarlos."

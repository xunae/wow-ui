...
function mod:FreneticChargeApplied(args)
	self:TargetMessage(args.spellId, "yellow", args.destName, CL.count:format(args.spellName, chargeCounter-1)) -- Target is after _start spell so adjust count in the warning

...
L["options:apps:raid-zul"] = "Faire apparaitre les barres de vie de monstres importants en surbrillance durant le combat contre \"%s\"."
L["options:apps:raid-zul:tooltip"] = "L'icône sera au dessus de la barre de vie de '%s' et '%s'."

...
L["If checked, the Corridor Creeper mount will be quieter."] = "勾选后，回廊潜行猎犬将变得安静一些。"
...
L["If checked, the Aerial Unit R-21X will be muted."] = "勾選後，航空單位R-21X將被靜音。"
...
L["If checked, the Corridor Creeper mount will be quieter."] = "勾選後，迴廊潛伏犬坐騎將被靜音。"
...
L["If checked, the Aerial Unit R-21X will be muted."] = "Если флажок установлен, то все звуки Воздушного судна R-21/X будут отключены."
...
L["If checked, the Corridor Creeper mount will be quieter."] = "Если флажок установлен, то будут отключены звуки Коридорного ужаса."
...
L["Show cooldowns above the player frame"] = "Показать кулдауны над рамкой игрока."
...
L["If checked, the Aerial Unit R-21X will be muted."] = "비행체 R-21X가 음소거됩니다."
...
L["If checked, the Corridor Creeper mount will be quieter."] = "회랑 지하사냥개가 더 조용해집니다."
...
L["If checked, the Sky Golem mount will be muted."] = "Wenn ausgewählt, wird der Sounds vom Himmelsgolem Reittier stumm geschalten."
...
L["If checked, Xiwyllag ATV will be muted."] = "Wenn ausgewählt, wird der Ton vom Xiwyllag-Flugfahrboot stumm geschalten."

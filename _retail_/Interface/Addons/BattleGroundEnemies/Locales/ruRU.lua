...
L["Auras_Buffs_Fontsize_Desc"] = "Размер стака на иконке баффа"
L["Auras_Buffs_ShowNumbers_Desc"] = "При включении на значках баффов будут числа, указывающие оставшееся время"
L["Auras_Buffs_Textcolor_Desc"] = "Цвет текста стаков на баффах"
...
L["LevelText_Textcolor_Desc"] = "Цвет текста для уровня"

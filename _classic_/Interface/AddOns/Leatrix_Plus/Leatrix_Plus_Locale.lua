...
L["If checked, nude and tabard toggle buttons will be added to the dressup frame and model rotation controls will be removed."] = "Wenn diese Option aktiviert ist, werden dem Ankleidefenster Schaltflächen zum Umschalten für Nakt und Wappenrock hinzugefügt und die Steuerelemente für die Modelldrehungen werden entfernt. "

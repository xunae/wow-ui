...
L.disableSfxDesc = "A opção 'Efeitos Sonoros' do WoW será desligada, then turned back on when the boss encounter is over. This can help you focus on warning sounds from BigWigs."

local L = BigWigs:NewBossLocale("Maut", "esES") or BigWigs:NewBossLocale("Maut", "esMX")
if not L then return end
if L then
	-- L.stage2_over = "Stage 2 Over - %.1f sec"
end

L = BigWigs:NewBossLocale("Shad'har the Insatiable", "esES") or BigWigs:NewBossLocale("Shad'har the Insatiable", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Drest'agath", "esES") or BigWigs:NewBossLocale("Drest'agath", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Il'gynoth, Corruption Reborn", "esES") or BigWigs:NewBossLocale("Il'gynoth, Corruption Reborn", "esMX")
if L then
	-- L.custom_on_fixate_plates = "Fixate icon on Enemy Nameplate"
	-- L.custom_on_fixate_plates_desc = "Show an icon on the target nameplate that is fixating on you.\nRequires the use of Enemy Nameplates. This feature is currently only supported by KuiNameplates."
end

L = BigWigs:NewBossLocale("Vexiona", "esES") or BigWigs:NewBossLocale("Vexiona", "esMX")
if L then
	-- L.killed = "%s killed"
end

L = BigWigs:NewBossLocale("Ra-den the Despoiled", "esES") or BigWigs:NewBossLocale("Ra-den the Despoiled", "esMX")
if L then
	-- L.essences = "Essences"
...
L = BigWigs:NewBossLocale("Carapace of N'Zoth", "esES") or BigWigs:NewBossLocale("Carapace of N'Zoth", "esMX")
if L then
	-- L.player_membrane = "Player Membrane" -- In stage 3
	-- L.boss_membrane = "Boss Membrane" -- In stage 3
end

L = BigWigs:NewBossLocale("N'Zoth, the Corruptor", "esES") or BigWigs:NewBossLocale("N'Zoth, the Corruptor", "esMX")
if L then

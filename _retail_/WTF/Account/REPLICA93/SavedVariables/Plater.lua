	...
	["profiles"] = {
		...
		["MyNewProfile"] = {
			...
			["script_data"] = {
				...
				{
					["ConstructorCode"] = "function (self, unitId, unitFrame, envTable)\n    --insert code here\n    envTable.IpseCastbarBorderPool = {}\n    local pool = envTable.IpseCastbarBorderPool\n    envTable.IpseGetCastbarBorder = function()\n        local icon;\n        \n        if (next(pool)) then\n            icon = table.remove(pool)\n            print(\"pool border\")\n        else\n            icon = CreateFrame(\"frame\", nil, unitFrame);\n            print(\"new border\")\n        end\n        \n        icon:SetBackdrop({\n                bgFile = \"Interface\\\\Buttons\\\\WHITE8X8\", \n                edgeFile = \"Interface\\\\Buttons\\\\WHITE8X8\", \n                tile = false, \n                tileSize = 0, \n                edgeSize = 1, \n                insets = { left = 0, right = 0, top = 0, bottom = 0}\n        })\n        icon:SetBackdropColor(0,0,0,0)\n        icon:SetBackdropBorderColor(1, 0, 0, 1)\n        \n        return icon;\n    end\n    envTable.IpseCastbarRecycle = function(border)\n        border:ClearAllPoints()\n        border:Hide()\n        table.insert(envTable.IpseCastbarBorderPool, border)\n    end\nend",
					["OnHideCode"] = "function (self, unitId, unitFrame, envTable)\n    --insert code here\n    if self.IpseCastbarBorder then\n        envTable.IpseCastbarRecycle(self.IpseCastbarBorder)\n        self.IpseCastbarBorder = nil \n    end\nend\n\n\n\n",
					["Temp_OnShowCode"] = "function (self, unitId, unitFrame, envTable)\n    --insert code here\n    local border = envTable.IpseGetCastbarBorder()\n    local w,h = unitFrame.castBar:GetSize()\n    border:SetPoint(\"CENTER\", unitFrame.castBar, \"CENTER\")\n    border:SetSize(w+1,h+1)\n    border:Show()\n    self.IpseCastbarBorder = border\nend",
					["ScriptType"] = 2,
					["UpdateCode"] = "function (self, unitId, unitFrame, envTable)\n    --insert code here\nend",
					["Time"] = 1557208725,
					["Temp_ConstructorCode"] = "function (self, unitId, unitFrame, envTable)\n    --insert code here\n    envTable.IpseCastbarBorderPool = {}\n    local pool = envTable.IpseCastbarBorderPool\n    envTable.IpseGetCastbarBorder = function()\n        local icon;\n        \n        if (next(pool)) then\n            icon = table.remove(pool)\n            print(\"pool border\")\n        else\n            icon = CreateFrame(\"frame\", nil, unitFrame);\n            print(\"new border\")\n        end\n        \n        icon:SetBackdrop({\n                bgFile = \"Interface\\\\Buttons\\\\WHITE8X8\", \n                edgeFile = \"Interface\\\\Buttons\\\\WHITE8X8\", \n                tile = false, \n                tileSize = 0, \n                edgeSize = 1, \n                insets = { left = 0, right = 0, top = 0, bottom = 0}\n        })\n        icon:SetBackdropColor(0,0,0,0)\n        icon:SetBackdropBorderColor(1, 0, 0, 1)\n        \n        return icon;\n    end\n    envTable.IpseCastbarRecycle = function(border)\n        border:ClearAllPoints()\n        border:Hide()\n        table.insert(envTable.IpseCastbarBorderPool, border)\n    end\nend\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n",
			...
			["url"] = "https://wago.io/3-QdGRm5z/1",
			["show_shield_prediction"] = false,
			["indicator_raidmark_scale"] = 0.63999998569489,
			...
			["plate_config"] = {
				...
				["enemyplayer"] = {
					...
					["big_actortitle_text_size"] = 10.512731552124,
					["spellpercent_text_outline"] = "NONE",
					["level_text_font"] = "Gotham Narrow Black",
					["percent_text_color"] = {
						1, -- [1]
					...
					["actorname_text_size"] = 9,
					["big_actorname_text_font"] = "Expressway",
					["big_actorname_text_size"] = 10.512731552124,
					["level_text_alpha"] = 1,
					["percent_text_font"] = "Expressway",
					["buff_frame_y_offset"] = 9,
					["percent_text_outline"] = "NONE",
			...
			["spell_animation_list"] = {
				...
				["264178"] = {
					["1"] = {
						["scaleY"] = 5.4171752929688,
						["fade_out"] = 0.079999998211861,
						["duration"] = 0.1499999910593,
						["absolute_sineY"] = false,
						["animation_type"] = "frameshake",
						["scaleX"] = -0.90336608886719,
						["absolute_sineX"] = false,
						["amplitude"] = 3,
						["fade_in"] = 0.0099999997764826,
						["enabled"] = true,
				...
				["116858"] = {
					["1"] = {
						["scale_upY"] = 1.0799999237061,
						["scale_upX"] = 1.0799999237061,
						["animation_type"] = "scale",
						["scale_downX"] = 0.91999995708466,
						["duration"] = 0.079999998211861,
						["scale_downY"] = 0.91999995708466,
						["cooldown"] = 0.75,
						["enabled"] = true,
					},
					["info"] = {
			...
			["hook_data"] = {
				...
				}, -- [3]
				{
					...
					["HooksTemp"] = {
						["Nameplate Created"] = "function (self, unitId, unitFrame, envTable)\n    \n    --run constructor!\n    \nend\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n",
						["Nameplate Added"] = "\n\n\n\n",
						["Cast Start"] = "function (self, unitId, unitFrame, envTable)\n    --insert code here\n    if (unitFrame.castBar and unitFrame.castBar.Icon and not unitFrame.IsSelf) then\n        local width, height = unitFrame.castBar:GetSize()\n        unitFrame.castBar.Spark:Hide()\n        unitFrame.castBar:SetPoint(\"TOPLEFT\", unitFrame.healthBar, \"BOTTOMLEFT\", height+1, -2)\n        unitFrame.castBar:SetPoint(\"TOPRIGHT\", unitFrame.healthBar, \"BOTTOMRIGHT\")\n        unitFrame.castBar.Icon:SetSize(height, height)\n        unitFrame.castBar.Icon:SetPoint(\"RIGHT\", unitFrame.castBar, \"LEFT\", -2, 0)\n        unitFrame.castBar.Icon:SetPoint(\"LEFT\", unitFrame.castBar, \"LEFT\", - (height) -2, 0)\n        --unitFrame.castBar.Icon:Show()\n        --print(unitFrame.castBar.Icon:GetPoint())\n        --print(unitFrame.castBar)\n    end\nend\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n",
						["Nameplate Removed"] = "\n\n",
						["Destructor"] = "function (self, unitId, unitFrame, envTable)\n    \n    envTable.CastbarBorderFrame:Hide()\n    \nend\n\n\n",
						["Constructor"] = "function (self, unitId, unitFrame, envTable)\n    \n    --size of the border\n    local borderSize = 1\n    \n    --transparency\n    local borderAlpha = 1\n    \n    --enabled (set to false it you only want to use the extra border in other scripts)\n    local isEnabled = false\n    \n    --export border (allow the border to be used by other scripts)\n    --other scripts can use:\n    --unitFrame.healthBar.extraBorder:Show()\n    --unitFrame.healthBar.extraBorder:SetVertexColor (r, g, b)\n    --unitFrame.healthBar.extraBorder:SetBorderSizes (borderSize)\n    local canExportBorder = true\n    \n    --do not add the border to personal bar\n    local noPersonalBar = true\n    \n    --private\n    do\n        \n        local newBorder = CreateFrame (\"frame\", nil, unitFrame.castBar, \"NamePlateFullBorderTemplate\")\n        envTable.CastbarBorderFrame = newBorder\n        \n        newBorder:SetBorderSizes (borderSize, borderSize, borderSize, borderSize)\n        newBorder:UpdateSizes()\n        newBorder:SetBackdropBorderColor(1, 0, 0, 1)\n        \n        \n        envTable.ShowOnPersonalBar = not noPersonalBar\n        \n        if (canExportBorder) then\n            unitFrame.healthBar.extraBorder = newBorder\n        end\n        \n        if (not isEnabled) then\n            envTable.IsEnabled = false\n        else\n            envTable.IsEnabled = true\n        end\n    end\n    \nend\n\n\n",
				...
				}, -- [15]
				{
					...
					["HooksTemp"] = {
						["Nameplate Created"] = "function (self, unitId, unitFrame, envTable)\n    \n    --run constructor!\n    \nend\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n",
						["Nameplate Added"] = "\n\n\n\n",
						["Cast Start"] = "function (self, unitId, unitFrame, envTable)\n    --insert code here\n    if (envTable.IsEnabled) then\n        if (unitFrame.IsSelf) then\n            if (envTable.ShowOnPersonalBar) then\n                envTable.CastbarBorderFrame:Show()\n            else\n                envTable.CastbarBorderFrame:Hide() \n            end\n        else\n            envTable.CastbarBorderFrame:Show()\n        end   \n    end\n    \nend\n\n\n",
						["Nameplate Removed"] = "\n\n",
						["Destructor"] = "function (self, unitId, unitFrame, envTable)\n    \nend\n\n\n",
						["Cast Stop"] = "function (self, unitId, unitFrame, envTable)\n    envTable.CastbarBorderFrame:Hide()\nend\n\n\n",
						["Constructor"] = "function (self, unitId, unitFrame, envTable)\n    \n    --size of the border\n    local borderSize = 1\n    \n    --transparency\n    local borderAlpha = 1\n    \n    --enabled (set to false it you only want to use the extra border in other scripts)\n    local isEnabled = false\n    \n    --export border (allow the border to be used by other scripts)\n    --other scripts can use:\n    --unitFrame.healthBar.extraBorder:Show()\n    --unitFrame.healthBar.extraBorder:SetVertexColor (r, g, b)\n    --unitFrame.healthBar.extraBorder:SetBorderSizes (borderSize)\n    local canExportBorder = true\n    \n    --do not add the border to personal bar\n    local noPersonalBar = true\n    \n    --private\n    do\n        \n        local newBorder = CreateFrame (\"frame\", nil, unitFrame.castBar, \"NamePlateFullBorderTemplate\")\n        envTable.CastbarBorderFrame = newBorder\n        \n        newBorder:SetBorderSizes (borderSize, borderSize, borderSize, borderSize)\n        newBorder:UpdateSizes()\n        newBorder:SetBackdropColor(0,0,0,0)\n        newBorder:SetVertexColor(0, 0, 0, 1)\n        \n        envTable.ShowOnPersonalBar = not noPersonalBar\n        \n        if (canExportBorder) then\n            unitFrame.healthBar.extraBorder = newBorder\n        end\n        \n        if (not isEnabled) then\n            envTable.IsEnabled = false\n        else\n            envTable.IsEnabled = true\n        end\n    end\n    \nend\n\n\n",
					},
					["Author"] = "Tecno-Azralon",
					["LastHookEdited"] = "Constructor",
					["Desc"] = "Add another border with more customizations. This border can also be manipulated by other scripts.",
			...
			["castbar_target_font"] = "Gotham Narrow Black",
			["aura_x_offset"] = 0,
			["first_run3"] = true,
			["script_data_trash"] = {
				{

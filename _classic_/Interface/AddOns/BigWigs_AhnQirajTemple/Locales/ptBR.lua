local L = BigWigs:NewBossLocale("The Prophet Skeram", "ptBR")
if not L then return end
if L then
	L.bossName = "Profeta Skeram"
end

local L = BigWigs:NewBossLocale("Silithid Royalty", "ptBR")
if L then
	L.bossName = "Realeza Silítidea"
end

local L = BigWigs:NewBossLocale("Battleguard Sartura", "ptBR")
if L then
	L.bossName = "Guarda de Batalha Sartura"
end

local L = BigWigs:NewBossLocale("Fankriss the Unyielding", "ptBR")
if L then
	L.bossName = "Fankriss, o Obstinado"
end
...
local L = BigWigs:NewBossLocale("Princess Huhuran", "ptBR")
if L then
	L.bossName = "Princesa Huhuran"
end

local L = BigWigs:NewBossLocale("The Twin Emperors", "ptBR")
if L then
	L.bossName = "Imperadores Gêmeos"
end

L = BigWigs:NewBossLocale("Ouro", "ptBR")
if L then
	L.bossName = "Ouroboros"

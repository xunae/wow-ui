...
L.disableSfx = "Désactiver les effets sonores"
L.disableSfxDesc = "L'option 'Effets sonores' des options de Son de WoW sera désactivé, et ensuite réactivé une fois que la rencontre de boss est terminée. Cela peut vous aider à vous concentrer sur les sons d'alerte de BigWigs."

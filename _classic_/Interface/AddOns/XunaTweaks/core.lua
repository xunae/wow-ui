...
function XunaTweaks:darkFrames()
	...
	for i, v in pairs({
		...
		MainMenuXPBarTexture0, MainMenuXPBarTexture1, MainMenuXPBarTexture2, MainMenuXPBarTexture3, MainMenuBarArtFrame.LeftEndCap, MainMenuBarArtFrame.RightEndCap,
		...
		if v then v:SetVertexColor(c, c, c) end
	end
end

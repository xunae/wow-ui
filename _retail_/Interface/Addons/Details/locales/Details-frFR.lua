...
L["STRING_OPTIONS_EXTERNALS_TITLE"] = "Widgets externes"
L["STRING_OPTIONS_EXTERNALS_TITLE2"] = "Ces options contrôlent le comportement de nombreux widgets externes."
...
L["STRING_OPTIONS_PVPFRAGS_DESC"] = "Quand activé, seuls les frags contre des joueurs ennemis comptent sur l'affichage |cFFFFFF00Dégâts > Frags|r."
...
L["STRING_OPTIONS_WC_LOCK_DESC"] = "Verrouillez ou déverrouillez une fenêtre. Lorsqu'elle est verrouillée, la fenêtre ne peut pas être déplacée."

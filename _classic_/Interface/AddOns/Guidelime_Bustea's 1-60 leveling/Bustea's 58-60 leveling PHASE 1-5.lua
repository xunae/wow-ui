...
[N58-60 Bustea's Horde Guide PHASE 1-5]
[D Bustea's  Horde Leveling guide https://twitch.tv/bustea/ ]
[GA Horde]

You should be level [XP58 58] to start this guide.
Hearth to [H Undercity]
Turn in [QT5023] and accept [QA5049]
Turn in [QT5049] and accept [QA5050]
[T] Train your level 58 spells(Druids will have to go to Moonglade and then fly back)
...
Turn in [QT5601] and accept [QA5149]
...
Once you have Pamela's Doll's Left Side, Right Side and Head. Right click them in your inventory to combine them for [QC5149]. 
Turn in [QT5149]
Accept [QA5241][QA5152]
...
Get the FP [P Light's Hope Chapel]
Turn in [QT5241][QT6030]
...
Accept [QA5238] and turn [QT5238 it] back in.
Turn in [QT5152] and accept [QA5153]
Search the graveyard just north of the house where Marlene Redpath is, look for "Joseph Redpath's Monument" among the graves [G49,76 Western Plaguelands]. Click the grave and get Joseph's Wedding Ring for [QC5153]
Turn in [QT5153] and accept [QA5154]
Accept [QA4971]
...
Turn in [QT5210] and accept [QA5181]
Turn in [QT6021]
You should now be level [XP59 59]. If not, grind a little on the Carrion Worms.
Ride west to the Infectis Scar by passing Corin's crossing by the south side.
Go down the Infectis Scar at [G49,74 Eastern Plaguelands], then go to [G53,65 Eastern Plaguelands] where you'll find the *Shattered Sword of Marduk*.
Loot it for [QC5181,2]
Go north to Blackwood Lake [G49,51 Eastern Plaguelands]. Take a dive, in the middle of the pool at the bottom you'll see Ghosts of Darrowshire fighting each other, amongst them you should see a glowing violet skull named *Horgus Skull* [G51,50 Eastern Plaguelands]
Loot it for [QC5181,1]
...
Go east to the Quel'Lithien Lodge [G51,22 Eastern Plaguelands]. Clear yourself a path to the main building, and clear towards the right-hand wing. You should find two level 60 Quel'Lithien Protectors, kill them and then loot the Quel'lithien Registry for [Q6133], which should be lying on a bench.
...
Clear your way out of Zul'Mashar then go southeast to Northdale, take a dive in the pool which is just south of Northdale. Clear the elementals in the way. At [G71,33 Eastern Plaguelands], next to a cage you should see a white flag with a blue runed on it named *Symbol of Lost Honor*
Loot it for [QC5845]
Turn in [QT5181][QT5211] at [G81,59 Eastern Plaguelands]
...
Ride south, get back on the road, then go east for a while and then go south towards the isle of Caer Darrow. Swim southeast to Caer Darrow isle, on the western side of Caer Darrow, find *Artist Renfray* in a wooden house [G65,75 Western Plaguelands]. Turn in [QT5846]
Hearth to [H Undercity]
Get the following Items from your bank: *Umi's Mechanical Yeti*, *Tinkee's Letter*, *Encased Corrupted Ooze*, *Glyphed Oaken Branch*
Take the Zeppelin to Orgrimmar.
Fly to [F Everlook]
Turn in [QT5163][QT4808]
...
Get off Fire Plume Ridge by the southern side and look for a *Primal Ooze* in the area south of the mountain [G50,67 Un'Goro Crater]. When you find one, engage it and before killing it right-click the Encased Corrupt Ooze from your inventory. You will release a little ooze which will merge with the Primal Ooze and create a Gargantuan Ooze. Kill it and loot the Merged Ooze Sample off it for [QC4642]
Get on your mount and ride northwest till you reach the mountain on your left-hand side, ride north along the mountain until you find two stone pillars [G29,22 Un'Goro Crater]. From there, follow the path going up the mountain until you zone into Silithus, keep going west on the road until you reach Cenarion Hold. In Cenarion Hold find the Wyvern Master and get the new flight path [P Cenarion Hold]
Hearth to [H Undercity]
Go to the AH and buy *240x Wool Cloth*, *240x Silk Cloth*, *240x Mageweave Cloth* and *240x Runecloth* from the AH, were gonna do Cloth Reputation Turn-ins for some extra EXP.
Turn in [QT4642]
Turn in [QT6390][QT5802]
Accept [QA7813], turn in [QT7813]
Accept [QA7814], turn in [QT7814]
Accept [QA7817], turn in [QT7817]
Accept [QA7818], turn in [QT7818]
Take the Zeppelin to Orgrimmar
Accept [QA7826], turn in [QT7826]
Accept [QA7827], turn in [QT7827]
Accept [QA7831], turn in [QT7831]
Accept [QA7824], turn in [QT7824]
Accept [QA7833], turn in [QT7833]
Accept [QA7834], turn in [QT7834]
Accept [QA7835], turn in [QT7835]
Accept [QA7836], turn in [QT7836]
Fly to [F Thunder Bluff]
Accept [QA7820], turn in [QT7820]
Accept [QA7821], turn in [QT7821]
Accept [QA7822], turn in [QT7822]
Accept [QA7823], turn in [QT7823]
Fly to [F Orgrimmar]
You have 2 Options now, either go do some dungeons to hit lvl 60, or grind in EPL for some extra Gold. *If you decide to do dungeons, you have reached the end of the guide, congrats on level 60!*
(Grinding)Take the Zeppelin to Undercity
(Grinding)Fly to [F Light's Hope Chapel]
(Grinding)Grind on all the mobs in southern EPL, preferably the *Carrion Grubs* until you reach level [XP60 60] as they drop *Larval Acid* which is a highly sought after Mat for Epic BiS Cloaks later on.

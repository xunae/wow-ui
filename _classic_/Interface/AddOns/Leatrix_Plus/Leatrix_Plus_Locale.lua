...
L["Drag to set the density of weather effects."] = "Перемещайте ползунок, чтобы установить желаемую плотность погодных эффектов."
L["Drag to set the font size of book text."] = "Перетащите, чтобы установить размер шрифта текста книги."
...
L["If checked, a master volume slider will be shown in the character sheet."] = "Если флажок установлен, то ползунок общей громкости будет отображаться на панели информации о персонаже."
...
L["If checked, class coloring will be used in the player frame and target frame."] = "Если флажок установлен, то цвет по классам будет не только на фрейме игрока, но и на цели и ее цели."
...
L["If checked, summon requests will be accepted automatically unless you are in combat."] = "Если флажок установлен, то запросы призыва будут подтверждаться автоматически, если вы не в бою."
...
L["If checked, the amount of time it takes to auto loot creatures will be significantly reduced."] = "Если флажок установлен, то время необходимое для поднятия добычи с существ - будет значительно уменьшено."
...
L["If checked, you will be able to change the font size of standard mail text.|n|nThis does not affect mail created using templates (such as auction house invoices)."] = "Если флажок установлен, вы сможете изменять размер шрифта текста в письмах."
L["If checked, you will be able to change the position and scale of the following frames:|n|n- Player frame|n- Target frame|n- Buffs frame|n- Widget top center frame|n- Timer bar"] = "Если флажок установлен, вы сможете изменить положение и масштаб следующих фреймов:|n|n- Рамка игрока|n- Рамка цели|n- Рамка баффов|n- Виджет верхней центральной рамки|n- Таймера"
...
L["If checked, you will be able to show a rare, elite or rare elite chain around the player frame."] = "Если флажок установлен, вы сможете добавить вокруг рамки игрока элитный или редкий (редко-элитный) контур."
...
L["Set weather density"] = "Настройка погодных эффектов"
...
L["Show player frame in class color"] = "Показать окно игрока в цвете класса"
...
L["Home"] = "Principal"
L["If checked, a bag search box will be shown in the backpack frame and the bank frame."] = "Si está marcado, se mostrará un cuadro de búsqueda de bolsas en el marco de la mochila y el marco del banco."
L["If checked, a button will be added to the character sheet which will show your equipped item durability when you hover the pointer over it.|n|nIn addition, an overall percentage will be shown in the chat frame when you die."] = "Si está marcado, se agregará un botón a la información del personaje que mostrará la durabilidad de su equipo cuando pase el puntero sobre él.|n|nAdemás, se mostrará un porcentaje general en el marco del chat cuando muera."
L["If checked, a group invite will be sent to anyone who whispers you with a set keyword as long as you are ungrouped, group leader or raid assistant."] = "Si está marcado, se enviará una invitación a grupo a cualquier persona que te susurre con una palabra clave establecida siempre y cuando estés desagrupado, líder de grupo o asistente de banda."
L["If checked, a master volume slider will be shown in the character sheet."] = "Si está marcado, se mostrará un control deslizante de volumen maestro en la información del personaje."
L["If checked, a minimap button will be available.|n|nClick - Toggle options panel.|n|nSHIFT/Left-click - Toggle music.|n|nCTRL/Right-click - Toggle errors (if enabled).|n|nCTRL/SHIFT/Left-click - Toggle Zygor (if installed).|n|nCTRL/SHIFT/Right-click - Toggle windowed mode."] = "Si está marcado, un botón de minimapa estará disponible.|n|nClic - Alternar panel de opciones.|n|nShift+Clic izquierdo: alternar música.|n|nCtrl+Clic derecho - Alternar errores (si está habilitado).|n|nCtrl+Shift+Clic izquierdo - Alternar Zygor (si está instalado)|n|nCtrl+Shift+Clic derecho - Alternar el modo de ventana."
L["If checked, additional functionality will be added to the auction house.|n|nBuyout only - create buyout auctions without filling in the starting price.|n|nGold only - set the copper and silver prices at 99 to speed up new auctions.|n|nFind item - search the auction house for the item you are selling.|n|nIn addition, the auction duration setting will be saved account-wide."] = "Si está marcado, se agregará funcionalidad adicional a la casa de subastas.|n|nSolo compra: cree subastas de compra sin completar el precio inicial.|n|nSolo oro: establezca los precios del cobre y la plata en 99 para acelerar las nuevas subastas.|n|nBuscar objeto: busca en la casa de subastas el objeto que estás vendiendo.|n|nAdemás, la configuración de duración de la subasta se guardará en toda la cuenta."
L["If checked, alert frames will not be shown."] = "Si está marcado, no se mostrarán los marcos de alerta."
L["If checked, all grey items in your bags will be sold automatically when you visit a merchant.|n|nYou can hold the shift key down when you talk to a merchant to override this setting."] = "Si está marcado, todos los objetos de calidad pobre en sus bolsas se venderán automáticamente cuando visite a un mercader.|n|nPuede mantener presionada la tecla shift cuando hable con un mercader para anular esta configuración."
L["If checked, backdrops will be tinted blue (friendly) or red (hostile)."] = "Si está marcado, los fondos se teñirán de azul (amigable) o rojo (hostil)."
L["If checked, BattleTag and Real ID friend requests will be automatically declined.|n|nEnabling this option will automatically decline any pending requests."] = "Si está marcado, las solicitudes de amistad de BattleTag y Real ID se rechazarán automáticamente.|n|nHabilitar esta opción rechazará automáticamente cualquier solicitud pendiente."
L["If checked, chat frame buttons will be hidden.|n|nClicking chat tabs will automatically show the latest messages.|n|nUse the mouse wheel to scroll through the chat history.  Hold down SHIFT for page jump or CTRL to jump to the top or bottom of the chat history."] = "Si está marcado, los botones del marco de chat estarán ocultos.|n|nAl hacer clic en las pestañas de chat, se mostrarán automáticamente los últimos mensajes.|n|nUsa la rueda del ratón para desplazarse por el historial de chat. Mantenga presionada la tecla shift para saltar de página o Ctrl para saltar a la parte superior o inferior del historial de chat."
L["If checked, chat text will not fade out after a time period."] = "Si está marcado, el texto del chat no se desvanecerá después de un período de tiempo."
L["If checked, class coloring will be used in the player frame and target frame."] = "Si está marcado, se usará el color de la clase en el marco del jugador y el marco del objetivo."
L["If checked, class colors will be used in the chat frame."] = "Si está marcado, los colores de la clase se usarán en el marco del chat."
L["If checked, class icons will be shown in the portrait frames."] = "Si está marcado, los iconos de clase se mostrarán en los marcos de retrato."
L["If checked, confirmations will no longer appear when you choose a loot roll option or attempt to sell or mail a tradable item."] = "Si está marcado, las confirmaciones ya no aparecerán cuando elija una opción de botín o cuando intente vender o enviar un objeto comercializable."
L["If checked, cooldown duration numbers will not be shown over the cooldowns.|n|nIf unchecked, cooldown duration numbers will be shown over the cooldowns if they are enabled in the game options panel ('ActionBars' menu)."] = "Si está marcado, los números de reutilización no se mostrarán sobre el hechizo.|n|nSi no está marcado, los números de reutilización se mostrarán sobre el hechizo si están habilitados en el panel de opciones del juego (menú 'Barras de Acción')."
L["If checked, damage and healing numbers in the player and pet portrait frames will be hidden."] = "Si está marcado, se ocultarán los números de daño y sanación en los marcos de retrato de jugador y mascota."
L["If checked, dragging the General chat tab while the chat frame is locked will expand the chat frame upwards.|n|nIf the chat frame is unlocked, dragging the General chat tab will move the chat frame."] = "Si está marcado, arrastrando la pestaña de chat General mientras el marco de chat está bloqueado expandirá el marco de chat hacia arriba.|n|nSi el marco de chat está desbloqueado, arrastrando la pestaña de chat General se moverá el marco de chat."
L["If checked, duel requests will be blocked unless the player requesting the duel is in your friends list or guild."] = "Si está marcado, las solicitudes de duelo se rechazarán a menos que el jugador que solicita el duelo esté en tu lista de amigos o hermandad."
L["If checked, emote sounds will be silenced while your character is resting or at the Grim Guzzler.|n|nEmote sounds will be enabled at all other times."] = "Si está marcado, los sonidos de emoción se silenciarán mientras tu personaje esté descansando o en el Tragapenas.|n|nLos sonidos de emoción se habilitarán en cualquier otro momento."
L["If checked, enemy nameplates will be shown during combat and hidden when combat ends."] = "Si está marcado, las placas identificativas del enemigo se mostrarán durante el combate y se ocultarán cuando finalice el combate."
L["If checked, group invites will only be sent to friends and guild members.|n|nIf unchecked, group invites will be sent to everyone."] = "Si está marcado, las invitaciones a grupos solo se enviarán a amigos y miembros de la hermandad.|n|nSi no está marcado, se enviarán invitaciones a grupos a todos."
L["If checked, guild names will be shown.  Guild ranks will also be shown for players in your guild."] = "Si está marcado, se mostrarán los nombres de las hermandades. Los rangos de hermandad también se mostrarán para los jugadores de tu hermandad."
L["If checked, helm and cloak toggle checkboxes will be shown in the character sheet.|n|nYou can hold shift and right-click the checkboxes to switch layouts."] = "Si está marcado, las casillas de alternar cabeza y espalda se mostrarán en la información del personaje.|n|nPuede mantener presionada la tecla shift y hacer clic con el botón derecho en las casillas de verificación para cambiar de visualización."
L["If checked, most error messages (such as 'Not enough rage') will not be shown.  Some important errors are excluded.|n|nIf you have the minimap button enabled, you can hold down the control key and right-click it to toggle error messages without affecting this setting."] = "Si está marcado, la mayoría de los mensajes de error (como 'No tienes suficiente ira') no se mostrarán. Se excluyen algunos errores importantes.|n|nSi tiene habilitado el botón de minimapa, puede mantener presionada la tecla de control y hacer clic con el botón derecho para alternar los mensajes de error sin afectar esta configuración."
L["If checked, nude and tabard toggle buttons will be added to the dressup frame and model rotation controls will be removed."] = "Si está marcado, se agregarán botones de alternancia desnudos y de tabardo al marco de probador y se eliminarán los controles de rotación del modelo."
L["If checked, party invitations from friends or guild members will be automatically accepted."] = "Si está marcado, las invitaciones a grupos de amigos o miembros de la hermandad serán aceptadas automáticamente."
L["If checked, party invitations will be blocked unless the player inviting you is in your friends list or guild."] = "Si está marcado, las invitaciones a grupos se rechazarán a menos que el jugador que te invite esté en tu lista de amigos o hermandad."
L["If checked, quests will be selected, accepted and turned-in automatically.|n|nQuests which have a gold requirement will not be turned-in automatically.|n|nYou can hold the shift key down when you talk to a quest giver to override this setting."] = "Si está marcado, las misiones serán seleccionadas, aceptadas y entregadas automáticamente.|n|nLas misiones que tienen un requisito de oro no se entregarán automáticamente.|n|nPuede mantener presionada la tecla shift cuando hable con un asignador de misiones para anular esta configuración."
L["If checked, raid chat and instance chat will both be colored blue (to match the default party chat color)."] = "Si está marcado, el chat de banda y el chat de instancia serán de color azul (para que coincida con el color predeterminado del chat del grupo)."
L["If checked, resurrection requests will be accepted automatically as long as the player resurrecting you is not in combat."] = "Si está marcado, las solicitudes de resucitación se aceptarán automáticamente siempre que el jugador que te resucite no esté en combate."
L["If checked, spell IDs will be shown in buff icon tooltips located in the buff frame and under the target frame."] = "Si está marcado, la ID de hechizo se mostrarán en el tooltip del icono de buff ubicado en el marco de buff y debajo del marco de objetivo."
L["If checked, sticky chat will be disabled.|n|nNote that this does not apply to temporary chat windows."] = "Si está marcado, el chat pegajoso se deshabilitará.|n|nTenga en cuenta que esto no se aplica a las ventanas de chat temporales."
L["If checked, summon requests will be accepted automatically unless you are in combat."] = "Si está marcado, las solicitudes de invocación serán aceptadas automáticamente a menos que estés en combate."
L["If checked, the addon list (accessible from the game menu) will show character based addons by default."] = "Si está marcado, la lista de addons (accesible desde el menú del juego) mostrará addons basados en personajes de forma predeterminada."
L["If checked, the amount of time it takes to auto loot creatures will be significantly reduced."] = "Si está marcado, el tiempo que se tarda en despojar automáticamente a las criaturas se reducirá significativamente."
L["If checked, the backpack clean-up button and the bank frame clean-up button will not be shown."] = "Si está marcado, el botón de limpieza de la mochila y el botón de limpieza del marco del banco no se mostrarán."
L["If checked, the button to toggle the raid container frame will be shown just above the raid management frame (left side of the screen) instead of in the raid management frame itself.|n|nThis allows you to toggle the raid container frame without needing to open the raid management frame."] = "Si está marcado, el botón para alternar el marco del contenedor de banda se mostrará justo encima del marco de administración de banda (lado izquierdo de la pantalla) en lugar de en el marco de administración de banda en sí.|n|nEsto le permite alternar el marco del contenedor de banda sin necesidad de abrir el marco de administración de banda."
L["If checked, the combat log will be hidden.|n|nThe combat log must be docked in order for this option to work.|n|nIf the combat log is undocked, you can dock it by dragging the tab (and reloading your UI) or by resetting the chat windows (from the chat menu)."] = "Si está marcado, el registro de combate estará oculto.|n|nEl registro de combate debe estar acoplado para que esta opción funcione.|n|nSi el registro de combate está desacoplado, puedes acoplarlo arrastrando la pestaña (y recargando tu IU) o restableciendo las ventanas de chat (desde el menú de chat)."
L["If checked, the editbox will be moved to the top of the chat frame."] = "Si está marcado, el cuadro de edición se moverá a la parte superior del marco de chat."
L["If checked, the grey screen of death and the netherworld effect will be disabled."] = "Si está marcado, la pantalla gris de la muerte y el efecto del inframundo se deshabilitarán."
L["If checked, the main bar gryphons will not be shown."] = "Si está marcado, no se mostrarán los grifos de la barra principal."
L["If checked, the number of free bag slots will be shown in the backpack button icon and tooltip."] = "Si está marcado, la cantidad de casillas para bolsas disponibles se mostrará en el icono del botón de la mochila y en el tooltip."
L["If checked, the player frame background will be shown in class color."] = "Si está marcado, el fondo del marco del jugador se mostrará en color de clase."
L["If checked, the professions frame will be larger."] = "Si está marcado, el marco de profesiones será más grande."
L["If checked, the quest log frame will be larger and feature a world map button and quest levels."] = "Si está marcado, el marco de registro de misiones será más grande y contará con un botón de mapa mundial y niveles de misión."
L["If checked, the screen glow will be disabled.|n|nEnabling this option will also disable the drunken haze effect."] = "Si está marcado, el brillo de la pantalla se deshabilitará.|n|nHabilitar esta opción también deshabilitará el efecto de borracho."
L["If checked, the skill trainer frame will be larger."] = "Si está marcado, el marco del instructor de habilidades será más grande."
L["If checked, the stance bar will not be shown."] = "Si está marcado, la barra de actitud no mostrará."
L["If checked, the talking frame will not be shown.|n|nThe talking frame normally appears in the lower portion of the screen when certain NPCs communicate with you."] = "Si está marcado, el marco de conversación no se mostrará.|n|nEl marco de conversación normalmente aparece en la parte inferior de la pantalla cuando ciertos PNJs se comunican con usted."
L["If checked, the target frame background will be shown in class color."] = "Si está marcado, el fondo del marco de objetivo se mostrará en color de clase."
L["If checked, the tooltip will be color coded and you will be able to modify the tooltip layout and scale."] = "Si está marcado, el tooltip estará codificada por colores y podrá modificar la visualización y la escala del tooltip."
L["If checked, the vendor price will be shown in item tooltips."] = "Si está marcado, el precio de venta se mostrará en el tooltip del objeto."
L["If checked, the zone text bar will be hidden.  The tracking button tooltip will show zone information."] = "Si está marcado, el texto de la zona estará oculta. El tooltip del botón de rastreo mostrará información de la zona."
L["If checked, the zoom buttons will be hidden.  You can use the mousewheel to zoom regardless of this setting."] = "Si está marcado, los botones de acercar/alejar estarán ocultos. Puede usar la rueda del ratón para acercar independientemente de esta configuración."
L["If checked, tooltips for world units will be hidden during combat.|n|nYou can hold the shift key down to override this setting."] = "Si está marcado, el tooltip para las unidades mundiales se ocultará durante el combate.|n|nPuede mantener presionada la tecla shift para anular esta configuración."
L["If checked, unit targets will be shown."] = "Si está marcado, se mostrarán los objetivos de la unidad."
L["If checked, Wowhead links will be shown above the quest log frame."] = "Si está marcado, los enlaces de Wowhead se mostrarán sobre el marco del registro de misiones."
L["If checked, you can hold down the alt key while opening a gossip window to automatically select a single gossip item.|n|nIf the gossip item type is banker, taxi, trainer or vendor, gossip will be skipped without needing to hold the alt key.  You can hold the shift key down to prevent this."] = "Si está marcado, puede mantener presionada la tecla alt mientras abre una ventana de diálogo para seleccionar automáticamente un solo tipo de diálogo.|n|nSi el tipo de diálogo es banquero, taxi, instructor o vendedor, se omitirán los diálogos sin necesidad de mantener presionada la tecla alt. Puede mantener presionada la tecla shift para evitar esto."
L["If checked, you can hold down the control key and click a chat tab to view recent chat in a copy-friendly window."] = "Si está marcado, puede mantener presionada la tecla de control y hacer clic en una pestaña de chat para ver el chat reciente en una ventana fácil de copiar."
L["If checked, you can open Leatrix Plus by pressing CTRL/Z."] = "Si está marcado, puede abrir Leatrix Plus presionando Ctrl+Z."
L["If checked, you can press the arrow keys to move the insertion point left and right in the chat frame.|n|nIf unchecked, the arrow keys will use the default keybind setting."] = "Si está marcado, puede presionar las teclas de flecha para mover el punto de inserción hacia la izquierda y hacia la derecha en el marco del chat.|n|nSi no está marcado, las teclas de flecha utilizarán la configuración predeterminada del teclado."
L["If checked, you will be able to cancel cinematics without being prompted for confirmation."] = "Si está marcado, podrá cancelar cinemáticas sin que se le solicite confirmación."
L["If checked, you will be able to change the font size of book text."] = "Si está marcado, podrá cambiar el tamaño de fuente del texto de libro."
L["If checked, you will be able to change the font size of quest text."] = "Si está marcado, podrá cambiar el tamaño de fuente del texto de misión."
L["If checked, you will be able to change the font size of standard mail text.|n|nThis does not affect mail created using templates (such as auction house invoices)."] = "Si está marcado, podrá cambiar el tamaño de fuente del texto de correo.|n|nEsto no afecta el correo creado con plantillas (como las facturas de la casa de subastas)."
L["If checked, you will be able to change the position and scale of the following frames:|n|n- Player frame|n- Target frame|n- Buffs frame|n- Widget top center frame|n- Timer bar"] = "Si está marcado, podrá cambiar la posición y la escala de los siguientes marcos:|n|n- Jugador|n- Objetivo|n- Buff|n- Artilugio central superior|n- Temporizador"
L["If checked, you will be able to create a viewport.  A viewport adds adjustable black borders around the game world.|n|nThe borders are placed on top of the game world but under the UI so you can place UI elements over them."] = "Si está marcado, podrá crear una ventana de vista. Una ventana de vista agrega bordes negros ajustables alrededor del mundo del juego.|n|nLos bordes se colocan en la parte superior del mundo del juego pero debajo de la interfaz de usuario para que pueda colocar elementos de la interfaz de usuario sobre ellos."
L["If checked, you will be able to customise the minimap."] = "Si está marcado, podrá personalizar el minimapa."
L["If checked, you will be able to drag the chat frame to the edge of the screen."] = "Si está marcado, podrá arrastrar el marco del chat al borde de la pantalla."
L["If checked, you will be able to place up to five beneficial cooldown icons above the target frame."] = "Si está marcado, podrá colocar hasta cinco iconos de reutilización sobre el marco del objetivo."
L["If checked, you will be able to reposition the tooltip."] = "Si está marcado, podrá reposicionar el tooltip."
L["If checked, you will be able to set the density of weather effects."] = "Si está marcado, podrá establecer la densidad de los efectos entornos."
L["If checked, you will be able to show a rare, elite or rare elite chain around the player frame."] = "Si está marcado, podrá mostrar una cadena de élite rara, élite o rara alrededor del marco del jugador."
L["If checked, you will be able to zoom out to a greater distance."] = "Si está marcado, podrá alejarse a una distancia mayor."
L["If checked, you will release automatically after you die in a battleground.|n|nYou will not release automatically if you have the ability to self-resurrect."] = "Si está marcado, liberarás automáticamente después de morir en un campo de batalla.|n|nNo lo liberarás automáticamente si tienes la capacidad de resucitarte a ti mismo."
L["If checked, your bags will not be opened or closed automatically when you interact with a merchant, bank or mailbox."] = "Si está marcado, sus bolsas no se abrirán o cerrarán automáticamente cuando interactúe con un mercader, banco o buzón."
L["If checked, your character will automatically stand or dismount when an action is prevented because you are either seated or mounted."] = "Si está marcado, tu personaje se levantará o desmontará automáticamente cuando se evite una acción porque estás sentado o montado."
L["If checked, your chat history will increase to 4096 lines.  If unchecked, the default will be used (128 lines).|n|nEnabling this option may prevent some chat text from showing during login."] = "Si está marcado, su historial de chat aumentará a 4096 líneas. Si no está marcado, se usará el valor predeterminado (128 líneas).|n|nHabilitar esta opción puede evitar que se muestre texto de chat durante el inicio de sesión."
L["If checked, your gear will be repaired automatically when you visit a suitable merchant.|n|nYou can hold the shift key down when you talk to a merchant to override this setting."] = "Si está marcado, su equipo se reparará automáticamente cuando visite a un mercader adecuado.|n|nPuede mantener presionada la tecla shift cuando hable con un mercader para anular esta configuración."
L["If checked, zone text will not be shown (eg. 'Ironforge')."] = "Si está marcado, el texto de la zona no se mostrará (por ejemplo, 'Forjaz')."
...
L["Quest completed."] = "Misión se ha completada"
L["Quest not completed."] = "Misión no se ha completada"
...
L["Accept resurrection"] = "Accepter la ressuscitation"
L["Accept summon"] = "Accepter l'invocation"
L["Addon"] = "Add-on"
L["Ahn'Qiraj"] = "Ahn'Qiraj"
...
L["Automate quests"] = "Automatisez les quêtes"
...
L["Class colored frames"] = "Cadres colorés de classe"
L["Class icon portraits"] = "Portraits d'icônes de classe"
L["Classic"] = "Classique"
...
L["Cloak"] = "Manteau"
L["Color the backdrops based on faction"] = "Colorez les décors en fonction de la faction"
...
L["Customise minimap"] = "Personnaliser la mini-carte"
L["D"] = "D"
...
L["Disable bag automation"] = "Désactiver l'automatisation du sac"
L["Disable chat fade"] = "Désactiver le fondu de discussion"
...
L["Disable sticky chat"] = "Désactiver la discussion collante"
...
L["Enable hotkey"] = "Activer le raccourci clavier"
L["Enable viewport"] = "Activer la fenêtre"
L["Enhance dressup"] = "Améliorer la cabine d'essayage"
L["Enhance professions"] = "Améliorer les professions"
L["Enhance quest log"] = "Améliorer le journal des quêtes"
L["Enhance trainers"] = "Améliorer les formateurs"
...
L["False"] = "Faux"
L["Faster auto loot"] = "La fouille automatique plus rapide"
...
L["Helm"] = "Heaume"
L["Help"] = "Aide"
L["Hide chat buttons"] = "Masquer les boutons de discussion"
...
L["Hide portrait numbers"] = "Masquer les numéros de portrait"
...
L["Hide tooltips for world units during combat"] = "Masquer les info-bulles des unités mondiales pendant le combat"
L["Hide zone text"] = "Masquer le texte de la zone"
L["High"] = "Haut"
L["Hillsbrad Foothills"] = "Contreforts d'Hillsbrad"
L["Hinterlands"] = "Les Hinterlands"
L["Home"] = "Principal"
L["If checked, a bag search box will be shown in the backpack frame and the bank frame."] = "Si coché, une boîte de recherche de sac sera affichée dans le cadre du sac à dos et le cadre de la banque."
L["If checked, a button will be added to the character sheet which will show your equipped item durability when you hover the pointer over it.|n|nIn addition, an overall percentage will be shown in the chat frame when you die."] = "Si coché, un bouton sera ajouté à la feuille de personnage qui montrera la durabilité de votre objet équipé lorsque vous passez le pointeur dessus.|n|nDe plus, un pourcentage global sera affiché dans le cadre de discussion lorsque vous mourrez."
L["If checked, a group invite will be sent to anyone who whispers you with a set keyword as long as you are ungrouped, group leader or raid assistant."] = "Si coché, une invitation de groupe sera envoyée à toute personne qui vous chuchote avec un mot clé défini tant que vous n'êtes pas groupé, chef de groupe ou assistant de raid."
L["If checked, a master volume slider will be shown in the character sheet."] = "Si coché, un curseur de volume principal sera affiché dans la feuille de personnage."
L["If checked, a minimap button will be available.|n|nClick - Toggle options panel.|n|nSHIFT/Left-click - Toggle music.|n|nCTRL/Right-click - Toggle errors (if enabled).|n|nCTRL/SHIFT/Left-click - Toggle Zygor (if installed).|n|nCTRL/SHIFT/Right-click - Toggle windowed mode."] = "Si coché, un bouton de minicarte sera disponible.|n|nCliquez sur - Basculer le panneau d'options.|n|nMaj+clic gauche - Basculer la musique.|n|nCtrl+Clic droit - Basculer les erreurs (si activé).|n|nCtrl+Maj+Clic gauche - Basculer Zygor (si installé).|n|nCtrl+Maj+Clic droit - Basculer en mode fenêtré."
L["If checked, additional functionality will be added to the auction house.|n|nBuyout only - create buyout auctions without filling in the starting price.|n|nGold only - set the copper and silver prices at 99 to speed up new auctions.|n|nFind item - search the auction house for the item you are selling.|n|nIn addition, the auction duration setting will be saved account-wide."] = "Si coché, des fonctionnalités supplémentaires seront ajoutées à l'hôtel des ventes|n|nAcheter seulement - créer des enchères de rachat sans renseigner le prix de départ.|n|nOr uniquement - fixez les prix du cuivre et de l'argent à 99 pour accélérer les nouvelles enchères.|n|nRechercher un objet - recherchez dans l'hôtel des ventes l'objet que vous vendez.|n|nEn outre, le paramètre de durée de l'enchère sera enregistré dans l'ensemble du compte."
L["If checked, alert frames will not be shown."] = "Si coché, les cadres d'alerte ne seront pas affichés."
L["If checked, all grey items in your bags will be sold automatically when you visit a merchant.|n|nYou can hold the shift key down when you talk to a merchant to override this setting."] = "Si coché, tous les objets de qualité médiocre dans vos sacs seront vendus automatiquement lors de votre visite chez un marchand.|n|nVous pouvez maintenir la touche Maj enfoncée lorsque vous parlez à un marchand pour remplacer ce paramètre."
L["If checked, backdrops will be tinted blue (friendly) or red (hostile)."] = "Si coché, les fonds seront teintés en bleu (amical) ou en rouge (hostile)."
L["If checked, BattleTag and Real ID friend requests will be automatically declined.|n|nEnabling this option will automatically decline any pending requests."] = "Si coché, les demandes de contact BattleTag et Nom réel seront automatiquement refusées.|n|nL'activation de cette option refusera automatiquement toutes les demandes en attente."
...
L["If checked, chat text will not fade out after a time period."] = "Si coché, le texte de discussion ne disparaîtra pas après un certain temps."
L["If checked, class coloring will be used in the player frame and target frame."] = "Si coché, la coloration de la classe sera utilisée dans le cadre du joueur et le cadre cible."
L["If checked, class colors will be used in the chat frame."] = "Si coché, les couleurs de classe seront utilisées dans le cadre de discussion."
L["If checked, class icons will be shown in the portrait frames."] = "Si coché, les icônes de classe seront affichées dans les cadres de portrait."
L["If checked, confirmations will no longer appear when you choose a loot roll option or attempt to sell or mail a tradable item."] = "Si coché, les confirmations n'apparaîtront plus lorsque vous choisissez une option de rouleau de butin ou tentez de vendre ou d'envoyer un objet échangeable."
L["If checked, cooldown duration numbers will not be shown over the cooldowns.|n|nIf unchecked, cooldown duration numbers will be shown over the cooldowns if they are enabled in the game options panel ('ActionBars' menu)."] = "Si coché, les numéros de durée de temps de recharge ne seront pas affichés au cours des temps de recharge.|n|nSi il n'est pas coché, les numéros de durée des temps de recharge seront affichés au-dessus des temps de recharge s'ils sont activés dans le panneau d'options de jeu (menu 'Barres d'action')."
L["If checked, damage and healing numbers in the player and pet portrait frames will be hidden."] = "Si coché, les nombres de dégâts et de soins dans les cadres de portrait de joueur et du familier seront cachés."
L["If checked, dragging the General chat tab while the chat frame is locked will expand the chat frame upwards.|n|nIf the chat frame is unlocked, dragging the General chat tab will move the chat frame."] = "Si coché, le fait de faire glisser l'onglet Général de discussion alors que le cadre de discussion est verrouillé étendra le cadre de discussion vers le haut.|n|nSi le cadre de discussion est déverrouillé, le fait de faire glisser l'onglet Général de discussion déplace le cadre de discussion."
L["If checked, duel requests will be blocked unless the player requesting the duel is in your friends list or guild."] = "Si coché, les demandes de duel seront bloquées sauf si le joueur qui demande le duel est dans votre liste d'amis ou votre guilde."
L["If checked, emote sounds will be silenced while your character is resting or at the Grim Guzzler.|n|nEmote sounds will be enabled at all other times."] = "Si coché, les sons d'émote seront réduits au silence pendant que votre personnage se repose ou dans Le Sinistre écluseur.|n|nLes sons d'émote seront activés à tout autre moment."
L["If checked, enemy nameplates will be shown during combat and hidden when combat ends."] = "Si coché, les barres d'info des ennemis seront affichées pendant le combat et cachées à la fin du combat."
L["If checked, group invites will only be sent to friends and guild members.|n|nIf unchecked, group invites will be sent to everyone."] = "Si coché, les invitations de groupe ne seront envoyées qu'aux amis et aux membres de la guilde.|n|nSi elle n'est pas cochée, les invitations de groupe seront envoyées à tout le monde."
L["If checked, guild names will be shown.  Guild ranks will also be shown for players in your guild."] = "Si coché, les noms de guilde seront affichés. Les grades de guilde seront également affichés pour les joueurs de votre guilde."
L["If checked, helm and cloak toggle checkboxes will be shown in the character sheet.|n|nYou can hold shift and right-click the checkboxes to switch layouts."] = "Si coché, les cases à cocher de l'heaume et de la cape seront affichées dans la feuille de personnage.|n|nVous pouvez maintenir la touche Maj enfoncée et cliquer avec le bouton droit sur les cases à cocher pour changer de disposition."
L["If checked, most error messages (such as 'Not enough rage') will not be shown.  Some important errors are excluded.|n|nIf you have the minimap button enabled, you can hold down the control key and right-click it to toggle error messages without affecting this setting."] = "Si coché, la plupart des messages d'erreur ne seront pas affichés. Certaines erreurs importantes sont exclues.|n|nSi le bouton de la mini-carte est activé, vous pouvez maintenir la touche de contrôle enfoncée et cliquer dessus avec le bouton droit pour basculer les messages d'erreur sans affecter ce paramètre."
L["If checked, nude and tabard toggle buttons will be added to the dressup frame and model rotation controls will be removed."] = "Si coché, des boutons à bascule nude et tabard seront ajoutés au cadre de la cabine d'essayage et les commandes de rotation du modèle seront supprimées."
L["If checked, party invitations from friends or guild members will be automatically accepted."] = "Si coché, les invitations de groupe d'amis ou de membres de guilde seront automatiquement acceptées."
L["If checked, party invitations will be blocked unless the player inviting you is in your friends list or guild."] = "Si coché, les invitations de groupe seront bloquées sauf si le joueur qui vous invite se trouve dans votre liste d'amis ou votre guilde."
...
L["If checked, raid chat and instance chat will both be colored blue (to match the default party chat color)."] = "Si coché, la discussion de raid et la discussion d'instance seront tous les deux colorés en bleu (pour correspondre à la couleur de chat du groupe par défaut)."
L["If checked, resurrection requests will be accepted automatically as long as the player resurrecting you is not in combat."] = "Si coché, les demandes de ressuscitation seront acceptées automatiquement tant que le joueur qui vous ressuscite n'est pas en combat."
L["If checked, spell IDs will be shown in buff icon tooltips located in the buff frame and under the target frame."] = "Si coché, les ID des sorts seront affichés dans les info-bulles des icônes de buff situées dans le cadre du buff et sous le cadre cible."
L["If checked, sticky chat will be disabled.|n|nNote that this does not apply to temporary chat windows."] = "Si coché, le chat collant sera désactivé.|n|nNotez que cela ne s'applique pas aux fenêtres de discussion temporaires."
L["If checked, summon requests will be accepted automatically unless you are in combat."] = "Si coché, les demandes d'invocation seront acceptées automatiquement, sauf si vous êtes en combat."
L["If checked, the addon list (accessible from the game menu) will show character based addons by default."] = "Si coché, la liste des add-ons (accessible depuis le menu du jeu) affichera les add-ons basés sur les personnages par défaut."
L["If checked, the amount of time it takes to auto loot creatures will be significantly reduced."] = "Si coché, le temps qu'il faut pour fouiller automatiquement les créatures sera considérablement réduit."
...
L["If checked, the button to toggle the raid container frame will be shown just above the raid management frame (left side of the screen) instead of in the raid management frame itself.|n|nThis allows you to toggle the raid container frame without needing to open the raid management frame."] = "Si coché, le bouton permettant de basculer le cadre du conteneur de raid sera affiché juste au-dessus du cadre de gestion du raid (côté gauche de l'écran) plutôt que dans le cadre de gestion du raid lui-même.|n|nCela vous permet de basculer le cadre du conteneur de raid sans avoir à ouvrir le cadre de gestion du raid."
L["If checked, the combat log will be hidden.|n|nThe combat log must be docked in order for this option to work.|n|nIf the combat log is undocked, you can dock it by dragging the tab (and reloading your UI) or by resetting the chat windows (from the chat menu)."] = "Si coché, le journal de combat sera caché.|n|nLe journal de combat doit être ancré pour que cette option fonctionne.|n|nSi le journal de combat n'est pas ancré, vous pouvez l'ancrer en faisant glisser l'onglet (et en rechargeant votre interface utilisateur) ou en réinitialisant les fenêtres de discussion (à partir du menu de discussion)."
L["If checked, the editbox will be moved to the top of the chat frame."] = "Si coché, la boîte d'édition sera déplacée en haut du cadre de discussion."
L["If checked, the grey screen of death and the netherworld effect will be disabled."] = "Si coché, l'écran gris de la mort et l'effet du monde inférieur seront désactivés."
L["If checked, the main bar gryphons will not be shown."] = "Si coché, les griffons de la barre principale ne seront pas affichés."
L["If checked, the number of free bag slots will be shown in the backpack button icon and tooltip."] = "Si coché, le nombre d'emplacements de sac vides sera affiché dans l'icône du bouton du sac à dos et dans l'infobulle."
L["If checked, the player frame background will be shown in class color."] = "Si coché, l'arrière-plan du cadre du joueur sera affiché en couleur de la classe."
L["If checked, the professions frame will be larger."] = "Si coché, le cadre des professions sera plus grand."
L["If checked, the quest log frame will be larger and feature a world map button and quest levels."] = "Si coché, le cadre du journal de quête sera plus grand et comportera un bouton de carte du monde et des niveaux de quête."
L["If checked, the screen glow will be disabled.|n|nEnabling this option will also disable the drunken haze effect."] = "Si coché, la lueur de l'écran sera désactivée.|n|nL'activation de cette option désactivera également l'effet de trouble ivre."
L["If checked, the skill trainer frame will be larger."] = "Si coché, le cadre du formateur sera plus grand."
L["If checked, the stance bar will not be shown."] = "Si coché, la barre de posture ne sera pas affichée."
L["If checked, the talking frame will not be shown.|n|nThe talking frame normally appears in the lower portion of the screen when certain NPCs communicate with you."] = "Si coché, le cadre parlant ne sera pas affiché.|n|nLe cadre parlant apparaît normalement dans la partie inférieure de l'écran lorsque certains PNJ communiquent avec vous."
L["If checked, the target frame background will be shown in class color."] = "Si coché, l'arrière-plan du cadre cible sera affiché dans la couleur de la classe."
L["If checked, the tooltip will be color coded and you will be able to modify the tooltip layout and scale."] = "Si coché, l'infobulle sera codée par couleur et vous pourrez modifier la disposition et l'échelle de l'infobulle."
L["If checked, the vendor price will be shown in item tooltips."] = "Si coché, le prix marchand sera affiché dans les info-bulles des objets."
L["If checked, the zone text bar will be hidden.  The tracking button tooltip will show zone information."] = "Si coché, la barre de texte de la zone sera masquée. L'info-bulle du bouton de suivi affiche des informations sur la zone."
L["If checked, the zoom buttons will be hidden.  You can use the mousewheel to zoom regardless of this setting."] = "Si coché, les boutons de zoom seront masqués. Vous pouvez utiliser la molette pour zoomer quel que soit ce paramètre."
L["If checked, tooltips for world units will be hidden during combat.|n|nYou can hold the shift key down to override this setting."] = "Si coché, les info-bulles des unités mondiales seront masquées pendant le combat.|n|nVous pouvez maintenir la touche Maj enfoncée pour remplacer ce paramètre."
L["If checked, unit targets will be shown."] = "Si coché, les cibles des unités seront affichées."
L["If checked, Wowhead links will be shown above the quest log frame."] = "Si coché, les liens Wowhead seront affichés au-dessus du cadre de journal de quête."
L["If checked, you can hold down the alt key while opening a gossip window to automatically select a single gossip item.|n|nIf the gossip item type is banker, taxi, trainer or vendor, gossip will be skipped without needing to hold the alt key.  You can hold the shift key down to prevent this."] = "Si coché, vous pouvez maintenir la touche alt enfoncée tout en ouvrant une fenêtre de dialogue pour sélectionner automatiquement un seul élément de dialogue.|n|nSi le type de dialogue est banquier, taxi, formateur ou vendeur, le dialogue sera ignoré sans avoir besoin de maintenir la touche alt. Vous pouvez maintenir la touche Maj enfoncée pour éviter cela."
L["If checked, you can hold down the control key and click a chat tab to view recent chat in a copy-friendly window."] = [=[Si coché, vous pouvez maintenir la touche de contrôle enfoncée et cliquer sur un onglet de discussion pour afficher la discussion récente dans une fenêtre de copie.

]=]
L["If checked, you can open Leatrix Plus by pressing CTRL/Z."] = "Si coché, vous pouvez ouvrir Leatrix Plus en appuyant sur Ctrl+Z."
...
L["If checked, you will be able to change the font size of book text."] = "Si coché, vous pourrez modifier la taille de la police du texte du livre."
L["If checked, you will be able to change the font size of quest text."] = "Si coché, vous pourrez modifier la taille de la police du texte de la quête."
L["If checked, you will be able to change the font size of standard mail text.|n|nThis does not affect mail created using templates (such as auction house invoices)."] = "Si coché, vous pourrez modifier la taille de police du texte de courrier standard.|n|nCela n'affecte pas le courrier créé à l'aide de modèles (tels que les factures de l'hôtel des ventes)."
L["If checked, you will be able to change the position and scale of the following frames:|n|n- Player frame|n- Target frame|n- Buffs frame|n- Widget top center frame|n- Timer bar"] = "Si cette case est cochée, vous pourrez modifier la position et l'échelle des cadres suivants:|n|n- Cadre joueur|n- Cadre cible|n- Cadre buffs|n- Cadre central supérieur du widget|n- Barre de minuterie"
L["If checked, you will be able to create a viewport.  A viewport adds adjustable black borders around the game world.|n|nThe borders are placed on top of the game world but under the UI so you can place UI elements over them."] = "Si coché, vous pourrez créer une fenêtre. Une fenêtre ajoute des bordures noires réglables dans le monde du jeu.|n|nLes bordures sont placées au-dessus du monde du jeu mais sous l'interface utilisateur afin que vous puissiez placer des éléments d'interface sur eux."
L["If checked, you will be able to customise the minimap."] = "Si coché, vous pourrez personnaliser la minicarte."
...
L["If checked, you will be able to place up to five beneficial cooldown icons above the target frame."] = "Si coché, vous pourrez placer jusqu'à cinq icônes de recharge bénéfiques au-dessus du cadre cible."
...
L["If checked, you will be able to show a rare, elite or rare elite chain around the player frame."] = "Si coché, vous pourrez montrer une chaîne rare, d'élite ou d'élite rare autour du cadre du joueur."
L["If checked, you will be able to zoom out to a greater distance."] = "Si coché, vous pourrez effectuer un zoom arrière sur une plus grande distance."
L["If checked, you will release automatically after you die in a battleground.|n|nYou will not release automatically if you have the ability to self-resurrect."] = "Si coché, vous serez automatiquement libéré après votre mort sur un champ de bataille.|n|nVous ne vous libérerez pas automatiquement si vous avez la capacité de ressusciter automatiquement."
L["If checked, your bags will not be opened or closed automatically when you interact with a merchant, bank or mailbox."] = "Si coché, vos sacs ne seront pas ouverts ou fermés automatiquement lorsque vous interagissez avec un marchand, une banque ou une boîte aux lettres."
L["If checked, your character will automatically stand or dismount when an action is prevented because you are either seated or mounted."] = "Si coché, votre personnage se lèvera ou se démontera automatiquement lorsqu'une action est empêchée parce que vous êtes assis ou monté."
L["If checked, your chat history will increase to 4096 lines.  If unchecked, the default will be used (128 lines).|n|nEnabling this option may prevent some chat text from showing during login."] = "Si coché, votre historique de discussion passera à 4096 lignes. Si elle n'est pas cochée, la valeur par défaut sera utilisée (128 lignes).|n|nL'activation de cette option peut empêcher certains textes de discussion de s'afficher pendant la connexion."
...
L["If checked, zone text will not be shown (eg. 'Ironforge')."] = "Si coché, le texte de la zone ne sera pas affiché (par exemple, «Ironforge»)."
L["Increase chat history"] = "Augmentez l'historique de discussion"
...
L["Invite from whispers"] = "Invitez des chuchotements"
L["Kalimdor"] = "Kalimdor"
L["Keyword"] = "Mot-clé"
...
L["Move editbox to top"] = "Déplacer la boîte d'édition vers le haut"
...
L["Quest not completed."] = "Quête non terminée."
L["Queue from friends"] = "File d'attente d'amis"
L["R"] = "R"
L["Ragefire Chasm"] = "Gouffre de Ragefeu"
L["Raid"] = "Raid"
L["Raid frame toggle"] = "Bascule de cadre de raid"
L["Random"] = "Aléatoire"
L["RARE"] = "RARE"
...
L["Sell junk automatically"] = "Vendre automatiquement des objets de qualité médiocre"
L["SELLING JUNK"] = "Vendre des objets de qualité médiocre"
L["Set weather density"] = "Définir la densité météorologique"
L["Settings"] = "Paramètres"
L["Shaders"] = "Shaders"
L["Shadowfang Keep"] = "Donjon d'Ombrecroc"
L["Show auction controls"] = "Afficher les contrôles d'hôtel des ventes"
L["Show bag search box"] = "Afficher la boîte de recherche de sacs"
L["Show character addons"] = "Afficher les add-ons de personnage"
L["Show cooldowns"] = "Afficher les temps de recharge"
L["Show durability status"] = "Afficher le statut de durabilité"
L["Show free bag slots"] = "Afficher les emplacements de sac vides"
L["Show guild names"] = "Afficher les noms de guilde"
L["Show minimap button"] = "Afficher le bouton de la mini-carte"
L["Show player chain"] = "Afficher la chaîne du joueur"
...
L["Show the spell ID in buff icon tooltips"] = "Afficher l'ID du sort dans les info-bulles des icônes de buff"
L["Show unit targets"] = "Afficher les cibles des unités"
L["Show vanity controls"] = "Afficher les commandes de vanité"
L["Show vendor price"] = "Afficher le prix marchand"
...
L["True"] = "Vrai"
L["Uldaman"] = "Uldaman"
L["Unclamp chat frame"] = "Débloquer le cadre de discussion"
L["Undercity"] = "Undercity"
L["Un'Goro Crater"] = "Cratère d'Un'Goro"
L["Universal group color"] = "Couleur de groupe universelle"
L["Use arrow keys in chat"] = "Utiliser les touches fléchées dans la discussion"
L["Use class colors in chat"] = "Utiliser des couleurs de classe dans la discussion"
L["Use easy resizing"] = "Utilisez un redimensionnement facile"
...
L["Class colored frames"] = "Quadros coloridos de classe"
L["Class icon portraits"] = "Retratos de ícone de classe"
L["Classic"] = "Clássico"
...
L["Disable bag automation"] = "Desativar automação de bolsa"
L["Disable chat fade"] = "Desativar esmaecimento do bate-papo"
L["Disable loot warnings"] = "Desativar avisos de butim"
L["Disable screen effects"] = "Desativar efeitos de tela"
L["Disable screen glow"] = "Desativar brilho da tela"
L["Disable sticky chat"] = "Desativar bate-papo permanente"
...
L["Enable viewport"] = "Ativar porta de visualização"
L["Enhance dressup"] = "Melhorar provador"
L["Enhance professions"] = "Melhorar profissões"
L["Enhance quest log"] = "Aprimorar o registro de missões"
L["Enhance trainers"] = "Melhorar treinadores"
L["Enhancements"] = "Melhorias"
L["Enter"] = "Entrar"
L["Enter the spell IDs for the cooldown icons that you want to see.|n|nIf a cooldown icon normally appears under the pet frame, check the pet checkbox.|n|nCooldown icons are saved to your class."] = "Digite os IDs do feitiço dos ícones de recarga que você deseja ver.|n|nSe um ícone de recarga normalmente aparecer embaixo do quadro do ajudante, marque a caixa de seleção ajudante.|n|nOs ícones de recarga são salvos na sua classe."
...
L["Extras"] = "Extras"
L["False"] = "Falso"
L["Faster auto loot"] = "Saque automático mais rápido"
...
L["Helm"] = "Elmo"
L["Help"] = "Ajuda"
L["Hide chat buttons"] = "Ocultar botões de bate-papo"
...
L["Hide portrait numbers"] = "Ocultar números de retrato"
L["Hide stance bar"] = "Ocultar barra de postura"
L["Hide the combat log"] = "Ocultar o registro de combate"
...
L["Hide zone text"] = "Ocultar texto da zona"
L["High"] = "Alto"
...
L["If checked, quests will be selected, accepted and turned-in automatically.|n|nQuests which have a gold requirement will not be turned-in automatically.|n|nYou can hold the shift key down when you talk to a quest giver to override this setting."] = "Se marcada, as missões serão selecionadas, aceitas e entregues automaticamente.|n|nAs missões que têm um requisito de ouro não serão entregues automaticamente.|n|nVocê pode manter a tecla Shift pressionada ao conversar com um entregador de missões para substituir essa configuração."
...
L["If checked, the number of free bag slots will be shown in the backpack button icon and tooltip."] = "Se marcado, o número de compartimentos de bolsa disponíveis será mostrado no ícone do botão da mochila e na dica de ferramenta."
...
L["If checked, the skill trainer frame will be larger."] = "Se marcado, o quadro do treinador de habilidades será maior."
...
L["If checked, you can hold down the alt key while opening a gossip window to automatically select a single gossip item.|n|nIf the gossip item type is banker, taxi, trainer or vendor, gossip will be skipped without needing to hold the alt key.  You can hold the shift key down to prevent this."] = "Se marcado, você pode manter pressionada a tecla alt enquanto abre uma janela de diálogo para selecionar automaticamente um único diálogo.|n|nSe o tipo de diálogo for banqueiro, táxi, treinador ou comerciante, o diálogo será ignorado sem a necessidade de pressionar a tecla alt. Você pode manter a tecla Shift pressionada para evitar isso."
...
L["Increase chat history"] = "Aumentar o histórico de bate-papo"
L["Interface"] = "Interface"
...
L["Manage tooltip"] = "Gerenciar dica de ferramenta"
...
L["Move editbox to top"] = "Mover a caixa de edição para o topo"
...
L["Quest completed."] = "Missão completa."
L["Quest not completed."] = "Missão não completa."
L["Queue from friends"] = "Fila de amigos"
L["R"] = "R"
L["Ragefire Chasm"] = "Cavernas Ígneas"
L["Raid"] = "Raide"
L["Raid frame toggle"] = "Alternar quadro de raide"
L["Random"] = "Aleatório"
L["RARE"] = "RARO"
L["RARE ELITE"] = "ELITE RARO"
L["Razorfen Downs"] = "Urzal dos Mortos"
L["Razorfen Kraul"] = "Urzal dos Tuscos"
L["Recent chat window"] = "Janela de bate-papo recente"
L["Redridge Mountains"] = "Montanhas Cristarrubra"
L["Release in PvP"] = "Libere em JxJ"
L["Reload"] = "Recarregar"
L["Repair automatically"] = "Reparar automaticamente"
...
L["Reset"] = "Redefinir"
L["Resize book text"] = "Redimensionar texto do livro"
L["Resize mail text"] = "Redimensionar texto do correio"
L["Resize quest text"] = "Redimensionar texto da missão"
...
L["Sell junk automatically"] = "Vender objetos de pobre qualidade automaticamente"
L["SELLING JUNK"] = "Vendendo objetos de pobre qualidade"
L["Set weather density"] = "Definir densidade do tempo"
L["Settings"] = "Configurações"
L["Shaders"] = "Shaders"
L["Shadowfang Keep"] = "Bastilha da Presa Negra"
L["Show auction controls"] = "Mostrar controles de leilão"
L["Show bag search box"] = "Mostrar caixa de pesquisa de bolsas"
L["Show character addons"] = "Mostrar addons do personagem"
L["Show cooldowns"] = "Mostrar recargas"
L["Show durability status"] = "Mostrar status de durabilidade"
L["Show free bag slots"] = "Mostrar compartimentos de bolsa disponíveis"
L["Show guild names"] = "Mostrar nomes de guilda"
L["Show minimap button"] = "Mostrar botão minimapa"
L["Show player chain"] = "Mostrar cadeia de jogadores"
...
L["Show vanity controls"] = "Mostrar controles personalizados"
L["Show vendor price"] = "Mostrar preço do comerciante"
L["Show volume slider"] = "Mostrar controle deslizante de volume"
L["Show Wowhead links"] = "Mostrar links do Wowhead"
L["Silence rested emotes"] = "Silencie os emotes descansados"
L["Silithus"] = "Silithus"
...
L["True"] = "Verdade"
L["Uldaman"] = "Uldaman"
L["Unclamp chat frame"] = "Desatar quadro de bate-papo"
L["Undercity"] = "Cidade Baixa"
L["Un'Goro Crater"] = "Cratera Un'Goro"
L["Universal group color"] = "Cor do grupo universal"
L["Use arrow keys in chat"] = "Use as teclas de flecha no chat"
L["Use class colors in chat"] = "Use cores da classe no chat"
L["Use easy resizing"] = "Use redimensionamento fácil"

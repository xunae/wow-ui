...
addonTable.AURA_SORT_MODE_NONE, addonTable.AURA_SORT_MODE_EXPIRETIME, addonTable.AURA_SORT_MODE_ICONSIZE, addonTable.AURA_SORT_MODE_AURATYPE_EXPIRE, addonTable.AURA_SORT_MODE_CUSTOM = 1, 2, 4, 6, 7;
...
addonTable.ICON_ANIMATION_DISPLAY_MODE_NONE, addonTable.ICON_ANIMATION_DISPLAY_MODE_ALWAYS, addonTable.ICON_ANIMATION_DISPLAY_MODE_THRESHOLD = 1, 2, 3;
addonTable.BORDER_TYPE_BUILTIN, addonTable.BORDER_TYPE_CUSTOM = 1, 2;

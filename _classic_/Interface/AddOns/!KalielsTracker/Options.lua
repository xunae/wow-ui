			...
			args = {
				sec0 = {
					...
					args = {
						...
						build = {
							name = " |cffffd100Build:|r  TBC Classic",
							type = "description",
							width = "normal",
							fontSize = "medium",
							order = 0.12,
			...
			args = {
				...
				sec3 = {
					...
					args = {
						...
						questsTooltipShowID = {
							name = "Show ID",
							desc = "Show Quest ID inside tooltips.",
							type = "toggle",
							disabled = function()
								return not db.questsTooltipShow
							end,
			...
			args = {
				...
				sec1 = {
					...
					args = {
						...
						addonQuestieDesc = {
							name = "Added Questie options - Show on Map, Set TomTom Waypoint.\n"..
									cBold.."TomTom|r support added through this addon.",
							type = "description",
							width = "double",
							order = 1.12,
						},
...
function KT:SetupOptions()
	...
	self.optionsFrame.quests = ACD:AddToBlizOptions(addonName, options.args.quests.name, self.title, "quests")

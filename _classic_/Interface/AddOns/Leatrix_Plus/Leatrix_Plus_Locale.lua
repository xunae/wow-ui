...
L["If checked, a group invite will be sent to anyone who whispers you with a set keyword as long as you are ungrouped, group leader or raid assistant and not queued for a battleground."] = "勾選後，只要您是未分隊的團長或團隊助理，並且沒有在戰場中排隊，就會向任何用設置的關鍵字對您密語的人發送組隊邀請，"
...
L["Dismount when casting a spell while moving"] = "Спешиваться при произнесении заклинания во время движения"
L["Dismount when clicking a flight destination"] = "Спешиваться при выборе конечной точки перелёта"
L["Dismount when not enough rage, mana or energy"] = "Спешиваться, если не достаточно ярости, маны или энергии"
L["Dismount when the flight map opens"] = "Спешиваться если вы откроете окно карты"

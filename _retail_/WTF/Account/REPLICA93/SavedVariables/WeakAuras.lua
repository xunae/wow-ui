...
WeakAurasSaved = {
	...
	["displays"] = {
		...
		["actionbar highlights"] = {
			...
			["controlledChildren"] = {
				"resto: hst", -- [1]
				"resto: concentrated flame", -- [2]
				"resto: devout spirit hs", -- [3]
				"ele: totem mastery", -- [4]
	...
	["frame"] = {
		["xOffset"] = -936.8363647460938,
		["yOffset"] = -78.7142333984375,

----------------------------------------------------------------------
-- 	Leatrix Plus 1.13.86 (18th November 2020)
----------------------------------------------------------------------
...
----------------------------------------------------------------------
	...
	function LeaPlusLC:Isolated()
		...
		if LeaPlusLC["EasyItemDestroy"] == "On" then
			...
			StaticPopupDialogs["DELETE_GOOD_ITEM"].OnHyperlinkLeave = function(self) GameTooltip:Hide() end

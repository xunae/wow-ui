...
L["STRING_OPTIONS_STRETCH"] = "Pulsante Movibile sul Lato Superiore"
L["STRING_OPTIONS_STRETCH_DESC"] = "Posiziona il pulsante movibile sulla parte superiore della finestra."
L["STRING_OPTIONS_STRETCHTOP"] = "Pulsante Movibile Sempre Sopra"
L["STRING_OPTIONS_STRETCHTOP_DESC"] = "Il pulsante movibile sarà posizionato sullo strato FULLSCREEN e si troverà sempre sopra agli altri frame. |cFFFFFF00Importante|r: Spostando la presa per uno layer alto, potrebbe stare davanti ad altri frame come gli zaini, usalo solo se ne hai davvero bisogno."

...
L["If checked, you will be able to change the position and scale of the following frames:|n|n- Player frame|n- Target frame|n- Buffs frame|n- Widget top center frame|n- Timer bar"] = "Si está seleccionado, podrá cambiar la posición y la escala de los siguientes marcos:|n|n- Jugador|n- Objetivo|n- Buff|n- Artilugio central superior|n- Temporizador"
...
L["If checked, you will be able to change the position and scale of the following frames:|n|n- Player frame|n- Target frame|n- Buffs frame|n- Widget top center frame|n- Timer bar"] = "Se marcado, você poderá alterar a posição e a escala dos seguintes quadros:|n|n- Quadro do jogador|n- Quadro de alvo|n- Quadro dos buffs|n- Quadro central superior do widget|n- Barra do temporizador"

...
L["options:alpha:alpha"] = "图标透明度（目标姓名板除外）"
L["options:alpha:alpha-target"] = "目标姓名板图标透明度"
--[[Translation missing --]]
...
这个光环将会发亮并且是默认大小]=]
L["options:aura-options:allow-multiple-instances"] = "允许该光环的多重实例"
...
L["options:general:hide-player-blizz-frame"] = "在玩家姓名板上隐藏暴雪的光环框架"
...
L["options:general:test-mode"] = "打开/关闭 测试模式"
...
L["options:size-and-position:scale-target"] = "目标姓名板图标大小"
--[[Translation missing --]]
...
L["options:timer-text:scale-font-size"] = [=[根据图标大小
缩放字体]=]
